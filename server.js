...
app.post("/api/groq", async (req, res) => {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      "Building a cheaper month plan: prefer add_planned_cashflow for known future expenses/transfers, plus add_task or add_plan_ahead for follow-through. Use add_subscription or set_forecast_risk_threshold when the user clearly asks.",
