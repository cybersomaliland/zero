...
app.post("/api/groq", async (req, res) => {
  ...
  try {
    ...
    const systemPrompt = [
      ...
      "3b) If decisionAssistant is present in context, treat it as the source of truth for 'Can I afford this?' answers: include the short-term verdict, week-end effect, month-end effect, and goal impact plainly.",
      "3c) If explainableMoneyMetrics is present and the user asks 'why' a number is low/high, use that explanation summary first before adding tone or advice.",
